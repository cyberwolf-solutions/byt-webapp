...
class PermissionSeeder extends Seeder {
    ...
    public function run(): void {
        $data = [
            ...
            ['name' => 'manage invoice', 'guard_name' => 'web'],
            ['name' => 'create invoice', 'guard_name' => 'web'],
            ['name' => 'view invoice', 'guard_name' => 'web'],
            ['name' => 'edit invoice', 'guard_name' => 'web'],
            ['name' => 'delete invoice', 'guard_name' => 'web'],
