                            ...
                            @foreach ($data as $product)
                                <tr>
                                    ...
                                    <td>{{ $settings->currency }}
                                        {{ number_format($product->total ? $product->total : 0, 2) }}
                                    </td>
                                    <td>{{ \Carbon\Carbon::parse($product->created_at)->format($settings->date_format) }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            `);
                ...
                printWindow.document.write('<div class="resort-name">BYT</div>');
